...
\setcounter{page}{-1}
\abstract{%
The explosion of data volume and ever-increasing speed of accelerators shift the bottleneck of large-scale distributed learning tasks from computation to communication. We observe significant pressure on the communication backends of various mainstream learning systems in multiple environments when running distributed learning tasks. Achieving efficient larger scale learning relies on more effective communication plane.
