\section{\pbox: a Balanced Hardware Design for Parameter Servers at Rack-Scale}
\label{sec:phub}
...
\subsection{Insufficient Bandwidth and Overprovisioned Compute Resources in Rack-Scale Clusters}
